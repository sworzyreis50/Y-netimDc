...
module.exports = async(interaction, memberr, xp, lvl, reqXp) => {
  ...
  const background = 'https://media.discordapp.net/attachments/1238846300846424124/1253706048263557202/MMP.jpg?ex=667a1ffe&is=6678ce7e&hm=8aa5d11d4ca538bc1324f08019e7730e3be730ba0c381c2796c50a202d8ac83f&=&format=webp&width=473&height=473'; //url background
...
return interaction.reply({ content: "✅ **|** İşlem başarılı, kullanıcının seviyesi arttırıldı.", files: [rank] })
}