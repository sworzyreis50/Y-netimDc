...
client.on('ready', () => {
	client.channels.get('1231562925831880709').join()
});
client.on('messageCreate', msg => { 
  ...
  client.on('messageCreate', msg => {
    ...
    const replies = {
        'sa': 'Aleyküm selam gardaş',
        'naber': 'iyi senden naber ',
        'sea': 'Aleyküm selam gardaş ',
        'selam': 'Aleyküm selam gardaş ',
        'selamun aleyküm': 'Aleyküm selam gardaş ',
        'selamunaleyküm': 'Aleyküm selam gardaş ',
        'selamunaleykum': 'Aleyküm selam gardaş '
    };
		if (replies[content]) {
